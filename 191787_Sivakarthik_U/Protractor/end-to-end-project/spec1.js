describe('Promise Demo',()=> { 
	...
	it('Order products', () => {
	    ...
	    element(By.id("ctl00_MainContent_fmwOrder_txtQuantity")).sendKeys("1");
        element(By.id("ctl00_MainContent_fmwOrder_txtUnitPrice")).sendKeys("8");
		element(By.xpath("/html/body/form/table/tbody/tr/td[2]/div[2]/table/tbody/tr/td/ol[1]/li[5]/input[2]")).click();
		element(By.name("ctl00$MainContent$fmwOrder$txtName")).sendKeys("Siva");
		element(By.id("ctl00_MainContent_fmwOrder_TextBox2")).sendKeys("Kadavanthra");
		...
		element(By.id("ctl00_MainContent_fmwOrder_TextBox5")).sendKeys("682321");
		element(By.id("ctl00_MainContent_fmwOrder_cardList_0")).click();
		element(By.id("ctl00_MainContent_fmwOrder_TextBox6")).sendKeys("2828");
	    element(By.id("ctl00_MainContent_fmwOrder_TextBox1")).sendKeys("01/01");
